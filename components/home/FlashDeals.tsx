  ...
  return (
    <section className="mx-auto space-y-6">
      ...
      <div className="sm:hidden space-y-4">
        {/* Mobile Header: Title and Timer Side by Side */}
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            <h2 className="text-[18px] font-semibold text-slate-900">{flashDealsData.title}</h2>
            <p className="flex items-center gap-2 text-[12px] font-base text-[#1B57A6]">
          ...
          <div className="flex items-end gap-1 text-[#1B57A6]">
            <div className="text-center">
              <p className="text-sm font-semibold leading-none">{activeDeal.countdown.days}</p>
              <p className="mt-0.5 text-[9px] text-[#6b93cd]">Days</p>
            </div>
            <span className="pb-2 text-sm">:</span>
            <div className="text-center">
              <p className="text-sm font-semibold leading-none">{activeDeal.countdown.hours}</p>
              <p className="mt-0.5 text-[9px] text-[#6b93cd]">Hour</p>
            </div>
            <span className="pb-2 text-sm">:</span>
            <div className="text-center">
              <p className="text-sm font-semibold leading-none">{activeDeal.countdown.minutes}</p>
              <p className="mt-0.5 text-[9px] text-[#6b93cd]">Minute</p>
            </div>
            <span className="pb-2 text-sm">:</span>
            <div className="text-center">
              <p className="text-sm font-semibold leading-none">{activeDeal.countdown.seconds}</p>
              <p className="mt-0.5 text-[9px] text-[#6b93cd]">Second</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center pt-2">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-md border border-[#89a8d6] px-6 py-2 text-sm font-medium text-[#1B57A6] transition hover:bg-[#f4f8ff]"
          >
            See more
      ...
      <div className="hidden sm:block space-y-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <p className="flex items-center gap-2 text-[12px] font-base text-[#1B57A6] sm:text-[2rem]">
              <FaRegClock className="h-3 w-3 sm:h-6 sm:w-6" />
              {flashDealsData.contestLabel}
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <Link
              href={flashDealsData.allDealsHref}
              className="lg:inline-flex hidden items-center gap-2 rounded-md border border-[#89a8d6] px-4 py-2 text-lg font-medium text-[#1B57A6] transition hover:bg-[#f4f8ff] sm:text-2xl"
            >
        ...
        <div className="h-[2px] w-[260px] bg-gradient-to-r from-[#2F73BD] via-[#2F73BD]/50 to-transparent sm:w-[380px]" />
        ...
        <div className="relative">
          <button
            ...
            className="absolute left-0 top-[245px] z-10 inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white text-[#1D3C61] shadow-md transition hover:border-[#2F73BD] hover:text-[#2F73BD] disabled:cursor-not-allowed disabled:border-slate-200 disabled:text-slate-300 -translate-x-1/2"
          >
          ...
          <button
            ...
            className="absolute right-0 top-[245px] z-10 inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white text-[#1D3C61] shadow-md transition hover:border-[#2F73BD] hover:text-[#2F73BD] disabled:cursor-not-allowed disabled:border-slate-200 disabled:text-slate-300 translate-x-1/2"
          >
