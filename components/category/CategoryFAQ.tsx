...
const CategoryFAQ: React.FC<CategoryFAQProps> = ({ categoryName }) => {
  return (
    <section className="mt-12 border-t border-slate-100 pt-10 pb-16">
      <div className="max-w-7xl">
        <h2 className="mb-6 text-xl font-bold text-slate-800 lg:text-2xl">
          Looking for Best {categoryName} products in Bangladesh?
        </h2>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            <h3 className="text-[15px] font-bold text-slate-700 lg:text-[16px]">
              Is Electra the most reliable source for genuine appliances in Bangladesh?
            </h3>
            <p className="text-[14px] leading-relaxed text-slate-600 lg:text-[15px]">
              ...
              <span className="font-bold">Refrigerator & Freezer</span> models. Every item comes with the full Official Manufacturer&apos;s Warranty, ensuring complete peace of mind and product authenticity across Bangladesh.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-[15px] font-bold text-slate-700 lg:text-[16px]">
              Does Electra offer Free Delivery and Free Installation services?
            </h3>
            <p className="text-[14px] leading-relaxed text-slate-600 lg:text-[15px]">
          ...
          {/* Duplicate question as per screenshot */}
          <div className="space-y-3">
            <h3 className="text-[15px] font-bold text-slate-700 lg:text-[16px]">
              How does Electra ensure the best prices and flexible payment options?
            </h3>
