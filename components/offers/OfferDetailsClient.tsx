...
interface OfferDetailsClientProps {
  initialData: FlashDealDetail;
}

export default function OfferDetailsClient({ initialData }: OfferDetailsClientProps) {
  const [detail] = useState<FlashDealDetail>(initialData);
