...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        const [pageRes, settings] = await Promise.all([
            fetch(`${baseUrl}/api/v2/pages/service-payment`, {
        ...
        const title = page?.meta_title || "Service Payment";
        const description = page?.meta_description || `Secure payment options for Samsung Electra services. Pay your service charges easily and safely.`;
        ...
        return { title: "Service Payment | Samsung Electra" };
    }
}
