        ...
        <section className="flex flex-col items-center gap-6 mt-12 px-4 md:px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 w-full px-6 md:px-10">
                {list.map((brand, index) => (
                    <div
                        key={index}
                        className="bg-white border border-slate-200 rounded-xl p-8 flex items-center justify-center aspect-[1.7/0.6] shadow-sm transition-all duration-300 hover:shadow-md group"
                    >
